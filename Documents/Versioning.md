# Mile.Aria2 Versioning

This document applies to all versions of Mile.Aria2.
...
The build number is the number of days since March 31, 2023 because the 
first version of Mile.Aria2 is created and published on that day.
